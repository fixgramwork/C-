...
class LeftCannonRightRocketArmRobot : public Robot {
public:
   LeftCannonRightRocketArmRobot(CannonArm& refLeftArm, RocketArm& refRightArm)
      : Robot(refLeftArm, refRightArm) {}
};
...
int main() {
   ...
   LeftCannonRightRocketArmRobot leftCannonArmRightRocketArmRobot(cannonArm, rocketArm);
